...
# The sample is doing a PUT blob API Operation
...
# Destination Container in Destination Account;
...
#Listing the blob from Source Container and matching the patter and copying them to destination container using PUT Operation;
...
for blob in blob_list:
        ...
        cb.upload_blob_from_url(str(sb.url))
