...
public class TestWorm
{
    ...
    {
        //StreamWriter file = new StreamWriter("azureevents.txt", append: true);

        //AzureEventSourceListener azureEventSourceListener = AzureEventSourceListener.CreateConsoleLogger(System.Diagnostics.Tracing.EventLevel.LogAlways);
