...
// This class file contains .Net Core 3.1 sample code to authenticate a service principal with certificate and use the certificate credentials to list blobs in a storage account.
...
namespace BlobSamples.SPNCertificates
{
    class ManageBlobWithServicePrincipalCertificateAuth
    {
        public void Main()
        {
