...
//*Demonstrate use of Copy Blob API*//
//Update storage account name and key
...
// update source URI
Uri sourceUri = new Uri("https://[storage account name].blob.core.windows.net/blobcontainer/blobname.txt");
BlobClient sourceblobClient = new BlobClient(sourceUri, sharedKeyCredential);

//Update destination URL
Uri destinationUri = new Uri("https://[storage account name].blob.core.windows.net/blobcontainer/blobname.txt");
 BlobClient destiniationblob = new BlobClient(destinationUri, sharedKeyCredential);


destiniationblob.StartCopyFromUri(sourceUri);
//Check Copy Status
