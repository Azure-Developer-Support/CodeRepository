...
#the script will help to check if the secured transfer required property(Enable HTTPS TrafficOnly) is enabled or disabled in all storage accounts in a subscription
