#The below PowerShell script helps you to delete the older blobs based on the Last Modified date from your storage account using Service Principal.
...
$SecuredPassword = ConvertTo-SecureString "<Secret ID>" -AsPlainText -Force
$TenantId = "<Tenant ID>"
