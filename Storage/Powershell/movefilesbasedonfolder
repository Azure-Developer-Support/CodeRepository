#The below PowerShell script helps to move the files from one container to different container based on folders.
#Disclaimer
...
$MaxReturn = 5000
$test=Get-AzureStorageBlob -Context $context -Container $container -Prefix $FolderName/ | Start-AzureStorageBlobCopy -DestContainer $container1
